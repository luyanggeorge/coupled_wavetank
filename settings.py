...
def test_case():
    ...
    test_case = "sb0.3_10_10_MSA"
    # yl added. Whether or not to apply mild-slope approximation (MSA)
    FWF = 0 # 1: use full weak forms (FWF); 0: apply MSA
    margin = 1.4 # adjust the initial length of the dry beach
    return input_data, test_case, FWF, margin
